...
class AM(Blackbox):
    def __init__(self, model, model_def, defense_levels=0.3, device=None, num_classes=10, rand_fhat=10, use_adaptive=True, *args, **kwargs):
    ...
    def from_modeldir(cls, model_dir, device=None, rand_fhat=False, use_adaptive=True, output_type='probs', **kwargs):
        ...
        blackbox = cls(model=model, model_def=model_def,
                       ...
                       defense_levels=0.3, device=device, num_classes=num_classes,
                       rand_fhat=rand_fhat,
