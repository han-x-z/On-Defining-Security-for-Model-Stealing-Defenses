...
class JacobianAdversary:
    ...
    def __init__(self, blackbox, budget, model_adv_name, model_adv_pretrained, modelfamily, seedset, testset,
                 ...
                 sigma=-1,
                 query_batch_size=1, aug_strategy='jbda', useprobs=True, final_train_epochs=10):
        ...
        self.testloader = DataLoader(self.testset, batch_size=self.batch_size, pin_memory=False)
...
def main():
    ...
    parser.add_argument('--train_epochs', metavar='N', type=int, help='# Epochs to train model', default=10)
    # ----------- Other params
