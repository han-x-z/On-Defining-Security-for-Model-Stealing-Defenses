...
def load_dataset_setting(task):
    if task == 'mnist':
        BATCH_SIZE = 100 #TODO
        N_EPOCH = 40
        # TO DO: N_EPOCH has been changed to 10 d
        ...
        trainset = torchvision.datasets.EMNIST(root='./raw_data/', split='letters', train=True, download=True, transform=transform)
        testset = torchvision.datasets.EMNIST(root='./raw_data/', split='letters', train=False, download=True, transform=transform)
        is_binary = False
        need_pad = False
        ...
        testset = torchvision.datasets.CIFAR100(root='./raw_data/', train=False, download=True, transform=transform)
        is_binary = False
        need_pad = False
        ...
        data_dir = './raw_data/imagewoof2-160'
